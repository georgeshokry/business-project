    ...
    <div>
        <v-container class="pa-0">
            ...
            <v-layout row wrap style="margin: auto; justify-content: center;padding-top: 5px;padding-bottom: 15px;">
                <v-item-group mandatory v-model="radioGroupEnt" style="width: 100%">
                    <v-container class="pa-0">

                        <v-layout row wrap style="margin: auto;justify-content: space-around;">

                            <v-flex lg5 xs5
                                    v-for="(item,n) in pricingEnt"
                                    :key="n"
        ...
        watch:{
            ...
            getPricingPlans(plans){
                ...
                for(let i in plans.plans){
                    if(plans.plans[i].type === 2 && plans.plans[i].active === 1){
                        this.pricingEnt.push({
                            id: plans.plans[i].id,
                ...
                this.radioGroupEnt = this.pricingEnt[0].id;
                this.pricingEnt.reverse();
            }
        },
        methods:{
            choice(id){
            ...
            goToPaymentEnter(){
                ...
                if(choiceId !== "") {
                    let priceToPay = this.pricingEnt.find(id => id.id === choiceId).amount;
